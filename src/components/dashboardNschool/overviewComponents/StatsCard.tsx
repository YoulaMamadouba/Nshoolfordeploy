        ...
        <div>
          ...
          {isActiveTenants ? (
            <div className="mt-0.5">
              <p className="text-xs text-gray-600">{change}% d&apos;activité</p>
            ...
            <div className="mt-0.5">
              ...
              <p className="text-[10px] text-gray-500 mt-0.5">Objectif: ${monthlyGoal.toLocaleString('en-US')}</p>
            </div>
          ) : conversionRate ? (
            <div className="mt-0.5">
              <p className={`text-xs ${change >= 0 ? 'text-green-600' : 'text-red-600'}`}>
              ...
              <p className="text-xs text-gray-600">Taux de conversion: {conversionRate.toFixed(1)}%</p>
            </div>
          ) : (
