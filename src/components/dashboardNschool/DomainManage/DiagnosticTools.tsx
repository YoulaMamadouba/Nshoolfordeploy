    ...
    <motion.div
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#2b4a6a]">Outils de Diagnostic</h2>
            <p className="text-gray-600">Tests et diagnostics avancés pour vos domaines</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="flex-1">
            <label className="block text-sm font-semibold text-[#2b4a6a] mb-2">Domaine à tester</label>
            <select
            ...
            >
              <div className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#2b4a6a]">{test.name}</h3>
