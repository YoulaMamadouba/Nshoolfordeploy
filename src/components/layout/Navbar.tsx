...
export default function AppNavbar() {
  ...
  return (
    <>
      ...
      {/* Menu Mobile - Déplacé en dehors du header pour éviter les conflits de z-index */}
      {mobileMenuOpen && (
            ...
            <div className="flex-1 mt-2 flow-root px-6 overflow-y-auto">
              <div className="-my-6 divide-y divide-orange-100">
                ...
                <div className="space-y-1 py-6">
                  {links.map((item, index) => (
                    ...
                    >
                      <Link
                        href={item.href}
                        className={`-mx-3 block rounded-lg px-3 py-3 text-lg font-medium transition-all duration-200 ${
                          pathname === item.href 
                            ? 'bg-gradient-to-r from-amber-50 to-orange-50 text-orange-600 shadow-sm' 
                ...
                <div className="py-6 space-y-4">
                  <div className="animate-in slide-in-from-bottom-4 duration-300" style={{ animationDelay: '400ms' }}>
                    <Link
                      href="/login"
                  ...
                  <div className="animate-in slide-in-from-bottom-4 duration-300" style={{ animationDelay: '500ms' }}>
                    <Link
                      href="/register"
